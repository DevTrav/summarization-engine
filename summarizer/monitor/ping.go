// Service monitor checks if site is up or down
...
// Ping pings a specific site and determines whether it's
//
//encore:api public path=/ping/*url
func Ping(ctx context.Context, url string) (*PingResponse, error) {
	// If the url doesn't start with http or https, default to "https:"
